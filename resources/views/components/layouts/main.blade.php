@props(['title', 'hideFooter' => false, 'sand' => false, 'description', 'overflow_hidden' => false])
@php
if (empty($title)) {
...
<body
    class="flex flex-col overflow-x-hidden  @if ($overflow_hidden) h-screen overflow-hidden @else min-h-screen @endif @if ($sand) lg:bg-sand @endif">
    <x-navbar />
