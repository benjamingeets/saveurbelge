    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                FileUpload::make('logo')->disk('public')->directory('logos')->default('logo-default.jpg'),
                FileUpload::make('banner')->disk('public')->directory('banners')->default('banner-default.jpg')
            ]);
    }
